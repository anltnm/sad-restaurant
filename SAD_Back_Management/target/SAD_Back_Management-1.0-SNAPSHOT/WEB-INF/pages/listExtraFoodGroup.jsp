...
<div class="row">
    <div id="breadcrumb" class="col-xs-12">
        <ol class="breadcrumb pull-left">
            ...
            <li><a href="./listExtraGroup">List Extra Food Group</a></li>
        </ol>
    </div>
</div>
<div class="row">
    <div class="form-group has-warning has-feedback">
        <form method="get" id="searchForm" action="search">
            <div class="col-sm-2">
                <a href="./addExtraFoodGroupView" class="btn btn-primary btn-label-left">
                    Add Extra Food Group
                </a>
            </div>
        ...
        <div class="box">
            ...
            <div class="box-content no-padding">
                <table class="table table-bordered table-striped table-hover table-heading"
                    ...
                    <tbody>
                    <c:forEach begin="0" items="${listExtraFoodGroup}" var="extraFoodItem" varStatus="index">
                        <tr>
                            <td>${index.index +1}</td>
                            <td><a href="./extraFoodDetailGroupByExtraGroup?id=${extraFoodItem.id}">${extraFoodItem.name}</a></td>
                            <td>
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu" role="menu">
                                        <li><a href="./updateExtraFoodGroupView?id=${extraFoodItem.id}">Update</a></li>
...
<script>
    ...
    callbackFunction = function () {
        $.ajax({
                    ...
                    url: window.location.origin + "/sad-bom/extraFood/delete_extra_food_group",
                    async: false,
                    success: function (data) {
                        if (data.statusCode == 0) {
                            ...
                            $("#popupMessage").text("Delete category is failed !");
                            openPopup(false);
                        }
                    }
                }
    ...
    function confirmDelete(_id) {
        $("#popupMessage").text("Please confirm delete category ?")
        openPopup(true);
        id = _id;
    }
</script>
